...
object TreeTests extends TestSuite {
  ...
  val roots = Array(
    Node("p1", ArrayBuffer(Node("c1", ArrayBuffer.empty), Node("c2", ArrayBuffer.empty))),
    Node("p2", ArrayBuffer(Node("c3", ArrayBuffer.empty), Node("c4", ArrayBuffer.empty)))
  )

  val moreNestedRoots = Array(
    Node("p1", ArrayBuffer(Node("c1", ArrayBuffer(Node("p2", ArrayBuffer.empty))))),
    Node("p3", ArrayBuffer(Node("d1", ArrayBuffer.empty)))
  )
